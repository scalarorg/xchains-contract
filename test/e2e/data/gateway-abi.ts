const GATEWAY_ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "tokenDeployer_", type: "address" },
    ],
  ...
  { inputs: [], name: "InvalidMintLimiter", type: "error" },
  ...
  { inputs: [], name: "NotMintLimiter", type: "error" },
  ...
  { anonymous: false, inputs: [], name: "ExecuteInit", type: "event" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  { anonymous: false, inputs: [], name: "ProofValidated", type: "event" },
  {
    anonymous: false,
    inputs: [],
    name: "SetCommandSelectorSuccess",
    type: "event",
  },
  { anonymous: false, inputs: [], name: "SignMessageHash", type: "event" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "address", name: "newMintLimiter", type: "address" },
    ],
