...
//         require(
//             _amount <= sbtc.balanceOf(msg.sender),
//             "BurnContract: insufficient balance"
//         );

//         uint256 currentApprovedAmount = sbtc.allowance(
//             msg.sender,
//             address(this)
//         );
//         if (currentApprovedAmount < _amount) {
//             sbtc.increaseAllowance(
//                 address(this),
//                 _amount - currentApprovedAmount
//             );
//         }
...
//         (bool success, ) = gateway.callContract(
//             destinationChain,
//             destinationAddress,
//             payload
//         );
//         require(success, "BurnContract: gateway call failed");
//     }
